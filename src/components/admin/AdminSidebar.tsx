...
import { LayoutDashboard, Building2, LogOut, Settings, CreditCard, Wallet, Database } from 'lucide-react';
...
const menuItems = [
  ...
  { icon: Database, label: 'Migração Externa', path: '/admin/migracao-externa' },
];
